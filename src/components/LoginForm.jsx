...
export default function LoginForm({ onLoginSuccess }) {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center" style={{ backgroundColor: '#31465B' }}>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8" style={{ backgroundColor: '#1E2532' }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#1E2532] text-gray-400">or</span>
              </div>
            </div>
